...
class namelist_creater:
    ...
    def __init__(self, STR_namelist="namelist.input", STR_DIR="./"):
        ...
        self.ARR_time_control = ['run_days', 'run_hours', 'run_minutes', 'run_seconds', 'start_year', 'start_month', 'start_day', 'start_hour', 'start_minute', 'start_second', 'end_year', 'end_month', 'end_day', 'end_hour', 'end_minute', 'end_second', 'interval_seconds', 'input_from_file', 'history_interval', 'history_outname', 'bdy_inname', 'input_inname', 'frames_per_outfile', 'auxhist1_outname', 'auxhist2_outname', 'auxhist1_interval', 'auxhist2_interval', 'frames_per_auxhist1', 'frames_per_auxhist2', 'aux1_time', 'aux2_time', 'interpolation_time', 'interpolation_number', 'restart', 'restart_interval', 'io_form_history', 'io_form_restart', 'io_form_input', 'io_form_boundary', 'debug_level', 'io_form_auxinput2', 'io_form_auxhist1', 'io_form_auxhist2', 'auxinput1_inname']

        self.ARR_domains = ['time_step', 'time_step_fract_num', 'time_step_fract_den', 'max_dom', 'e_we', 'e_sn', 'e_vert', 'p_top_requested', 'num_metgrid_levels', 'num_metgrid_soil_levels', 'dx', 'dy', 'grid_id', 'parent_id', 'i_parent_start', 'j_parent_start', 'parent_grid_ratio', 'feedback', 'use_adaptive_time_step', 'step_to_output_time', 'target_cfl', 'max_step_increase_pct', 'starting_time_step', 'max_time_step', 'min_time_step', 'adaptation_domain', 'smooth_option', 'sfcp_to_sfcp']
        ...
        self.ARR_stoch = ['skebs', 'stoch_vertstruc_opt', 'tot_backscat_psi', 'tot_backscat_t', 'ztau_psi', 'ztau_t', 'nens', 'ISEED_SKEBS']
        ...
        "input_from_file"                  : { "VALUE":  False       , "DATA_TYPE" : "BLN" , "ARR_TYPE" :"M"},
        ...
        "auxinput1_inname"                 : { "VALUE":  'm'      , "DATA_TYPE" : "STR" , "ARR_TYPE" :"S", "STR_FMT" : "{0:s}{1:05d}_d<domain>.<date>,"}}
        ...
        "max_dom"                          : { "VALUE":  1           , "DATA_TYPE" : "INT" , "ARR_TYPE" :"S"},
        ...
        "use_adaptive_time_step"           : { "VALUE":  False       , "DATA_TYPE" : "BLN" , "ARR_TYPE" :"S"},
        ...
        "non_hydrostatic"                  : { "VALUE":  False       , "DATA_TYPE" : "BLN" , "ARR_TYPE" :"M"},
    ...
    def read_user_specific(self, ARR_run_time_in=[], ARR_start_time_in=[], ARR_end_time_in=[]):
        ...
        self.DIC_user = {\
        "run_days"                         : {"VALUE": [ ARR_run_time[2] for d in range(self.NUM_MAX_DOM)], "DATA_TYPE": "IND" ,"STR_FMT": "     {0:02d}," },\
        "run_hours"                        : {"VALUE": [ ARR_run_time[3] for d in range(self.NUM_MAX_DOM)], "DATA_TYPE": "IND" ,"STR_FMT": "     {0:02d},"},\
        "run_minutes"                      : {"VALUE": [ ARR_run_time[4] for d in range(self.NUM_MAX_DOM)], "DATA_TYPE": "IND" ,"STR_FMT": "     {0:02d},"},\
        "run_seconds"                      : {"VALUE": [ ARR_run_time[5] for d in range(self.NUM_MAX_DOM)], "DATA_TYPE": "IND" ,"STR_FMT": "     {0:02d},"},\
    ...
    def write_namelist(self, DIC_in, ARR_in):
        DIC_DATA_TYPE_STR = {"FLT": "{0:7.2f},","BLN": "{0:s},","INT": "{0:7d},","STR": "'{0:s}'," }
        for ARR_item in ARR_in :
            ...
            if DIC_in[ARR_item]["ARR_TYPE"] == "S":
                ...
                if DIC_in[ARR_item]["DATA_TYPE"] == "BLN":
                    ...
                    self.FILE.write(DIC_in[ARR_item]["STR_FMT"].format(DIC_in[ARR_item]["VALUE"], self.NUM_ensemble_member))
                else:
    ...
    def write_sensibility_namelist(self, STR_variable, NUM_dom, ARR_list=[] ):
        return 0
